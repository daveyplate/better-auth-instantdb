...
import { anonymousPlugin, passkeyPlugin, usernamePlugin } from "./plugins"
...
// Export the plugins from the plugins folder
export { anonymousPlugin, usernamePlugin, passkeyPlugin }
